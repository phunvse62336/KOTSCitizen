...
const ApplicationStyles = {
  ...
  doneTextCaseView: {fontSize: 18},
  SOSTextCaseView: {fontSize: 18, color: 'red'},
  normalCaseTextCaseView: {fontSize: 17, color: Colors.appColor},
  timeCaseView: {fontSize: 13, marginTop: 5, color: 'gray'},
  ...
  doneStatusCaseView: {fontSize: 15, marginTop: 5, color: 'gray'},
  cancelStatusCaseView: {fontSize: 15, marginTop: 5, color: 'red'},
  statusCaseView: {fontSize: 15},
  callButtonCaseView: {
    width: 70,
    height: 50,
